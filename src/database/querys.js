export const querys = {
  ...
  crearReclamo:"INSERT INTO reclamos (documento, idSitio, idDesperfecto, descripcion, estado, idReclamoUnificado) VALUES (@documento, @idSitio, @idDesperfecto, @descripcion, @estado, @idReclamoUnificado); INSERT INTO detalleReclamos (lugarReclamo, imagen1, imagen2, imagen3, imagen4, imagen5, imagen6, imagen7, idReclamo) VALUES (@lugarReclamo, @imagen1, @imagen2, @imagen3, @imagen3, @imagen4, @imagen5, @imagen6, @imagen7, (SELECT MAX(distribuidas.dbo.reclamos.idReclamo) FROM distribuidas.dbo.reclamos); (SELECT MAX(distribuidas.dbo.reclamos.idReclamo) as idReclamo FROM distribuidas.dbo.reclamos)",
